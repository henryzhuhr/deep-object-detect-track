...
from inferencer.types.backend import BaseDetectBackend

from .tensorrt_utils import TensorRTVersionInfo, support_trt_version_list


class BaseTensorRTDetectorBackend(BaseDetectBackend):
    NAME = "TensorRT"
